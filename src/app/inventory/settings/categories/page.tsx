...
import { loadDraft, type SupabaseLike } from "@/lib/inventory/forms/drafts";
...
import {
  autofillCategoryDescriptionsAction,
  deleteCategoryAction,
  linkCategoryToSiteAction,
  saveCategoryAction,
  saveCategoryDraftAction,
  toggleCategoryActiveAction,
  unlinkCategoryFromSiteAction,
} from "./actions";
import {
  CATEGORY_KIND_LABELS,
  CATEGORY_SETTINGS_DRAFT_KEY,
  TABLE_ACTION_BUTTON_CLASS,
  TABLE_DELETE_BUTTON_CLASS,
  asText,
  buildPageUrl,
  extractInventoryKind,
  loadCategoryRows,
